package com.guozongkui.testimsdk.widget;
...
public class AutoLinkTextView extends TextView {
    ...
    private void initWidth(Context context, AttributeSet attrs){
        TypedArray array = context.obtainStyledAttributes(attrs, io.rong.imkit.R.styleable.AutoLinkTextView);
        mMaxWidth = array.getDimensionPixelSize(io.rong.imkit.R.styleable.AutoLinkTextView_RCMaxWidth, 0);
